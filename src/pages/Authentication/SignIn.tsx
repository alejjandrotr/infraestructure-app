...
export const SignInPage: React.FC<{ navigate: any }> = ({ navigate }: { navigate: any }) => {
  ...
  const onSubmit = async (data: LoginDto) => {
    setIsLoading(true);
    try {
      const save = await userRepository.login({ ...data });
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">Sistema de CINE UDONE</p>
              <p className="2xl:px-20">DESARROLLADO EN EL 2024 - 2025</p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Inicie Sesion en Sistema de Cine
              </h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                {loading && (
                  <div className="flex justify-center">
                    ...
                    {/* Add a loader element if needed */}
                  </div>
                )}
              </form>
            </div>
